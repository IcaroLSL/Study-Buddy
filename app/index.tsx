        ...
        >
          <View className="overflow-hidden rounded-3xl bg-sky-500 shadow-2xl">
            <View className={isDark ? 'bg-gray-800 p-8' : 'bg-white p-8'}>
                ...
                <View className="flex-row items-center justify-between">
                  <View className="flex-row items-center">
                    <Switch
                      ...
                      value={rememberMe}
                    />
                    <Text className={isDark ? 'ml-2 text-sm text-gray-300' : 'ml-2 text-sm text-gray-700'}>
                      Lembrar de mim
                    </Text>
                  </View>
              ...
              <Text className={isDark ? 'my-6 text-center text-gray-400' : 'my-6 text-center text-gray-500'}>
                ou
              </Text>
